...
class Student:
    ...
    def displayGPA(self):
        ...
        try:
            totalgpa = 'GPA of student ' + self.name + ' is ' + str(gpa / len(self.courses)) 
            return totalgpa
    ...
    def displayCourses(self):
        final_dict = {}
        for courses in self.courses.keys():
            if self.courses[courses] > 0:
                final_dict[courses] = self.courses[courses]
